export const serviceAreas = {
  faisalabad: {
    ...
    title: "Industrial embroidery manufacturing in Faisalabad.",
    description:
      "KAATTEX is a Faisalabad-based industrial embroidery manufacturer serving B2B textile, apparel, and home-textile programs from Pul Abdullah Bridge on Main Samundri Road.",
    intro:
  ...
  lahore: {
    ...
    title: "Industrial embroidery for Lahore textile and apparel teams.",
    description:
      "KAATTEX serves Lahore-based textile and apparel manufacturers from its Faisalabad embroidery production floor, supporting B2B sampling, digitization, and bulk embroidery programs.",
    intro:
